...
public class CommandBarTests
{
    ...
    public async Task Echo_command_streams_output_and_reports_exit_zero()
    {
        ...
        vm.CommandBar.Input = "echo hello-duet";
        ...
        Assert.Contains(vm.CommandBar.Output, l => l.Text.Contains("hello-duet"));
        Assert.Equal("", vm.CommandBar.Input);
        Assert.Equal("echo hello-duet", vm.CommandBar.RanCommand);
    }
